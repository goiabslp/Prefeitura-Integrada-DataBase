...
export const DEFAULT_USERS: User[] = [
  {
    ...
    permissions: ['parent_criar_oficio', 'parent_compras', 'parent_diarias', 'parent_admin', 'parent_agendamento_veiculo', 'parent_agricultura', 'parent_obras', 'parent_calendario', 'parent_rh']
  },
  {
    id: 'user_juliana',
    username: 'jmv',
