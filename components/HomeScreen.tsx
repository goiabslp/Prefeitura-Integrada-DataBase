                        ...
                        <div className="space-y-6 w-full max-w-5xl">
                            ...
                            <div className={`grid grid-cols-1 md:grid-cols-${(activeBlock === 'licitacao' && userRole === 'admin') ? '2' : (activeBlock === 'licitacao' || (activeBlock === 'compras' && canManagePurchaseOrders)) ? '3' : '2'} gap-8 pt-4`}>
                                ...
                                {activeBlock === 'licitacao' && userRole === 'admin' && (
                                    <button onClick={onManageLicitacaoScreening} className="group p-8 bg-white border border-slate-200 rounded-[2rem] hover:border-amber-300 transition-all flex flex-col items-center text-center h-56 justify-center">
