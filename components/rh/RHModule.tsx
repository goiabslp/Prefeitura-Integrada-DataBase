                    ...
                    {!isFormView ? (
                        <div className="max-w-7xl mx-auto w-full animate-fade-in">
                            ...
                            <button
                                ...
                                className="group flex items-center gap-2 text-slate-400 hover:text-indigo-600 font-bold transition-all w-fit mb-6"
                            >
                                <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
                                <span className="text-xs uppercase tracking-widest text-slate-500">Voltar ao Início</span>
                            </button>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                >
                                    ...
                                    <h3 className="text-xl font-bold text-slate-800 mb-2 text-center">Lançamento de Horas Extras</h3>
                                ...
                                >
                                    ...
                                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-500 to-slate-800 text-white flex items-center justify-center mb-6 shadow-lg shadow-indigo-500/30 group-hover:scale-110 transition-transform duration-300">
                                        <History className="w-8 h-8" />
                                    </div>
                                    <h3 className="text-xl font-bold text-slate-800 mb-2 text-center">Histórico</h3>
                                    <p className="text-slate-500 text-sm text-center max-w-[200px]">Visualize e edite lançamentos de horas extras realizados anteriormente.</p>
                                </button>
