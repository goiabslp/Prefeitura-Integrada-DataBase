...
import { ShieldCheck, Car, User, MapPin, Clock, CheckCircle2, XCircle, AlertCircle, Calendar, ArrowLeft, Lock, Info, Target, FileText, ChevronDown, Check, Building2, Activity, Navigation, X } from 'lucide-react';
...
export const VehicleScheduleApprovals: React.FC<VehicleScheduleApprovalsProps> = ({
  ...
  const pending = schedules.filter(s => s.status === 'pendente').sort((a, b) => b.createdAt.localeCompare(a.createdAt));
