...
import { 
  ...
  MapPin, Droplets, Maximize, Heading 
} from 'lucide-react';
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <button onClick={() => fileInputRef.current?.click()} className="px-4 py-2 bg-slate-900 text-white text-sm font-bold rounded-lg hover:bg-indigo-600 transition-colors flex items-center gap-2">
