    ...
    return (
        <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4">
            ...
            <motion.div
                ...
                className="relative w-full max-w-md bg-white rounded-[2rem] md:rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.2)] border border-white/20 overflow-hidden max-h-[90vh] flex flex-col"
            >
